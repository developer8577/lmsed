...
const Player = () => {
  const { enrolledCourses, calculateChapterTime, backendUrl, getToken, userData, fetchUserEnrolledCourses, getYouTubeId } = useContext(AppContext)
  ...
  return courseData ? (
    ...
    <>
      <div className="p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36 flex-1">
        {/* left column */}
